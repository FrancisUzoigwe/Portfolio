...
const TimeLine: React.FC = () => {
  const experiences: Experience[] = [
    ...
    },
    {
      ...
      title: "Full Stack Developer",
      description:
        "Led a team in building a scalable e-commerce platform using React, Redux, and MongoDB.",
    },
    {
      year: 2024,
  ...
  return (
    <div className="container mx-auto px-4 w-full mt-4">
      <div className="relative w-full md:w-full lg:w-9/10 xl:w-full 2xl:w-3/4 md:mx-auto md:text-center">
        <div className="relative md:mx-auto  md:text-center">
          {experiences.map((experience, index) => (
            <div
              key={index}
              className={`mb-8 flex md:flex-row flex-col ${
                index % 2 === 0 ? "md:items-start" : "md:items-end"
              }`}
              style={{ marginTop: index === 0 ? 0 : "-1rem" }}
            >
              ...
              >
                <div className="w-50px h-50px mr-4">
                  <div className="w-10 h-10 bg-[orange] text-white rounded-full flex items-center justify-center absolute top-0 transform -translate-x-1/2 -translate-y-1/2 left-1/2">
              ...
              >
                <div className="bg-white text-black p-4 rounded-lg shadow-md">
                  <h2 className="text-lg font-bold mb-2">{experience.title}</h2>
                  <li className="mb-2 w-full text-[15px] font-bold text-left">
                    {experience.description}
                  </li>
                </div>
              </div>
